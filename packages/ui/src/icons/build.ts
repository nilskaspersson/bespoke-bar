...
const header = "// Generated by src/icons/build.ts. Do not edit.";
...
console.log(
	`Built ${localNames.length} icons in ${Math.round(performance.now() - start)}ms → src/icons/{sprite.svg,types.ts,kits.types.ts}`,
);
