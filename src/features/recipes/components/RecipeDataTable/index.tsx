...
export function RecipeDataTable({ recipes, members }: Props) {
	/**
	...
	return (
		<TableLayout table={table} searchPlaceholder="Search for recipes…">
			<Table>
...
export function RecipeDataTableSkeleton() {
	return (
		<SkeletonScreen>
			<Grid gap={1}>
...
RecipeDataTable.Skeleton = RecipeDataTableSkeleton;
